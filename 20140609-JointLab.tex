...
\title{Next-generation multigridding: adaptivity and communication avoidance}
...
\date{JointLab Workshop, INRIA Sophia Antipolis, 2014-06-09 \\[1em]
This talk: \url{http://59A2.org/files/20140609-JointLab.pdf}}
...
\begin{frame}{Segmental refinement: no horizontal communication}
  \begin{center}
    \includegraphics[width=0.8\textwidth]{figures/MG/sr-comm.png}
  \end{center}
  \begin{itemize}
  \item Add overlap below transition level---no horizontal communication
  \item Remain accurate up to discretization error
  \end{itemize}
\end{frame}

\begin{frame}{Segmental refinement: experiments}
  \begin{itemize}
...
\begin{frame}{HPGMG-FE: a finite-element FAS benchmark}
  \begin{itemize}
  \item \url{https://hpgmg.org}, v0.1 released
...
\begin{frame}
  \centering
  \includegraphics[width=0.75\textwidth]{figures/hpgmg-fv-20140515-dof.png}
\end{frame}
