...
\subtitle{This talk: \url{http://59A2.org/files/20130618-PRACE.pdf}}
...
\begin{itemize}
  \item \shell{git clone https://bitbucket.org/jedbrown/pbratu-2013-prace}
  \item \shell{cd pbratu-2013-prace}
  \item \shell{git checkout 1-initial}
  \item \shell{make}
...
\input{slides/PETSc/SNESNew.tex}
