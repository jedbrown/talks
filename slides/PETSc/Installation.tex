...
\begin{itemize}\footnotesize
  ...
  \item \shell{./configure -{}-with-mpi-dir=/usr/ \mtab \bslash \\
...
\item reconfigure at any time with \\
  {\footnotesize \shell{gnu-dbg/conf/reconfigure-gnu-dbg.py \mtab\bslash\\
...
\begin{frame}{An optimized build}
  \begin{itemize}
  \item \shell{\small gnu-dbg/conf/reconfigure-gnu-dbg.py \\
      PETSC\_ARCH=gnu-opt \\
      -{}-with-debugging=0 \&\& make PETSC\_ARCH=gnu-opt}
