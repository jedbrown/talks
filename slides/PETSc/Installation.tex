...
\begin{itemize}
  ...
  \begin{itemize}\footnotesize
    \item \shell{\small hg clone \mtab\bslash \\
     \scriptsize http://petsc.cs.iit.edu/petsc/releases/petsc-3.2}
    \item \shell{cd petsc-3.2}
    \item \shell{\scriptsize hg clone http://petsc.cs.iit.edu/petsc/releases/BuildSystem-3.2 \mtab\bslash \\
...
\begin{itemize}\footnotesize
  ...
  \item \shell{./configure -{}-with-shared-libraries \mtab \bslash \\
...
\item Other common options
  \begin{itemize}\footnotesize
  \item \code{-{}-with-mpi-dir=/path/to/mpi}
