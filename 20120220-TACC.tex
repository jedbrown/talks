...
\subtitle{This talk: \url{http://59A2.org/files/20120220-TACC.pdf}}
...
\begin{itemize}
  \item \shell{hg clone \\
  {\footnotesize http://petsc.cs.iit.edu/petsc/tutorials/TACC12}}
  \item \shell{cd TACC12}
...
\input{slides/SNES/MultiphysicsAssemblyCode.tex}
